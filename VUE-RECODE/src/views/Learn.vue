    ...
    <div class="learn-container">
        ...
        <section class="learn-hero">
            <div class="hero-content">
                ...
                <p>
                    Explore interactive lessons, tutorials, and exercises
                    designed to help you master GCSE mathematics
                </p>
                ...
                <div v-if="filteredLessons.length > 0" class="lessons-grid">
                    ...
                    >
                        <div class="lesson-header">
                            ...
                            <span
                                class="difficulty"
                                :class="`difficulty-${lesson.difficulty.toLowerCase()}`"
                            >
                                {{ lesson.difficulty }}
                            </span>
                        </div>
            ...
            <div class="features-container">
                ...
                <div class="features-grid">
                    <div class="feature">
                        ...
                        <h3>ML-Personalized</h3>
                        <p>
                            Our machine learning algorithms adapt to your
                    ...
                    <div class="feature">
                        ...
                        <p>
                            Curated by mathematics educators and industry
                            experts
                        </p>
                    </div>
                </div>
...
const allLessons: Lesson[] = [
    {
        ...
        description:
            "Master the basics of algebraic equations, variables, and expressions",
        category: "Algebra",
        difficulty: "Beginner",
        duration: 45,
        lessons: 12,
    },
    {
        ...
        description:
            "Solve quadratic equations using various methods and techniques",
        category: "Algebra",
    ...
    },
    {
        ...
        description:
            "Learn sine, cosine, and tangent functions with real-world applications",
    ...
    },
    {
        ...
        description:
            "Shapes, angles, and spatial reasoning with practical examples",
        category: "Geometry",
        difficulty: "Beginner",
        duration: 40,
        lessons: 11,
...
const filteredLessons = computed(() => {
    return allLessons.filter((lesson) => {
        ...
        const matchesCategory =
            ...
            lesson.category === selectedCategory.value;
